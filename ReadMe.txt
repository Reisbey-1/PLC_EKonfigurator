========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : EKonfigurator
========================================================================


Diese EKonfigurator-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre EKonfigurator-Anwendung bilden.
...
EKonfigurator.h
	...
	Anwendungsklasse CEKonfiguratorApp.
...
res\EKonfigurator.ico
    Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
	Symbol wird durch die Haupt-Ressourcendatei EKonfigurator.rc eingebunden.

res\EKonfigurator.rc2
...
EKonfiguratorDlg.h, EKonfiguratorDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CEKonfiguratorDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in EKonfigurator.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	EKonfigurator.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
